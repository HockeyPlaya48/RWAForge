      ...
      <div className="flex gap-1 rounded-xl border border-slate-800 bg-slate-900/40 p-1">
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-2.5 text-sm font-medium transition-all ${
            tab === "rewards" ? "bg-mint text-navy shadow-sm" : "text-slate-400 hover:text-slate-100"
          }`}
        >
          My Rewards
        </button>
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-2.5 text-sm font-medium transition-all ${
            tab === "operator" ? "bg-mint text-navy shadow-sm" : "text-slate-400 hover:text-slate-100"
          }`}
        >
          Operator Tools
        </button>
